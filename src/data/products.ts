// Farm and product images served from Supabase Storage
import {
  FARM_SAYMAYAT as saymayatImg,
  FARM_URBAN_GARDEN as urbanGardenImg,
  FARM_LA_FAUSTINO as laFaustinoImg,
  FARM_PCJEAM as pcjeamImg,
  FARM_DULCHE as dulcheImg,
  FARM_CSB_FAMILY as csbFamilyImg,
  FARM_FIT_FAB as fitFabImg,
  FARM_MLS_HARVEST as mlsHarvestImg,
  FARM_ATOK_HIGHLANDS as atokHighlandsImg,
  FARM_KIBUNGAN as kibunganImg,
  FARM_BAKUN_VALLEY as bakunValleyImg,
  FARM_MANKAYAN as mankayanImg,
  FARM_BSU_STRAWBERRY as bsuStrawberryImg,
  FARM_ITOGON_MIXED as itogonMixedImg,
  FARM_TUBLAY_BERRY as tublayBerryImg,
  FARM_PINSAO_URBAN as pinsaoUrbanImg,
  PRODUCT_IMAGES as P,
} from "@/lib/siteImages";

// Product image aliases for backward compatibility
const cabbageImg = P.cabbage;
const chineseCabbageImg = P.chineseCabbage;
const baguioBeansImg = P.baguioBeans;
const broccoliImg = P.broccoli;
const celeryImg = P.celery;
const potatoesImg = P.potatoes;
const radishImg = P.radish;
const koreanRadishImg = P.koreanRadish;
const cauliflowerImg = P.cauliflower;
const sayoteImg = P.sayote;
const leeksImg = P.leeks;
const pechayImg = P.pechay;
const lettuceImg = P.lettuce;
const carrotsImg = P.carrots;
const strawberriesImg = P.strawberries;
const mangoesImg = P.mangoes;
const papayasImg = P.papayas;
const bananasImg = P.bananas;
const calamansiImg = P.calamansi;
const freshEggsImg = P.freshEggs;
const carabaoMilkImg = P.carabaoMilk;
const kesongPutiImg = P.kesongPuti;
const saltedEggsImg = P.saltedEggs;
const guavaImg = P.guava;
const watermelonImg = P.watermelon;
const pineappleImg = P.pineapple;
const dragonFruitImg = P.dragonFruit;
const avocadoImg = P.avocado;
const arabicaCoffeeImg = P.arabicaCoffee;
const wildHoneyImg = P.wildHoney;
const driedHerbsImg = P.driedHerbs;
const muscovadoImg = P.muscovado;
const ubeJamImg = P.ubeJam;
const tableaImg = P.tablea;
const brownRiceImg = P.brownRice;
const coconutVinegarImg = P.coconutVinegar;
const peanutButterImg = P.peanutButter;
const tomatoesImg = P.tomatoes;
const blueberriesImg = P.blueberries;
const grapesImg = P.grapes;
const honeyImg = P.honey;
const gingerImg = P.ginger;
const turmericImg = P.turmeric;
const passionFruitImg = P.passionFruit;
const lemongrassImg = P.lemongrass;
const sweetPotatoImg = P.sweetPotato;
const stringBeansImg = P.stringBeans;
const eggplantImg = P.eggplant;
const bellPeppersImg = P.bellPeppers;
