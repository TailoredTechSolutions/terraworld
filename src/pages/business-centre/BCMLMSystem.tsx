...
import {
  ...
  CheckCircle2, XCircle, AlertTriangle, BarChart3 } from
"lucide-react";
...
const BCMLMSystem = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* BV Rule Banner */}
      <div className="p-2 rounded-lg bg-amber-500/5 border border-amber-500/20 text-amber-700 dark:text-amber-400 text-sm">
        <strong className="text-sm">MLM Rules:</strong> Only Terra Fee = BV. Binary 1:1 at 10% lesser leg. Paid members only for binary/matching. Left+right active + product volume required. Matching: upline rank ≥ downline rank. BV tracked separately: left/right × product/membership.
      </div>
